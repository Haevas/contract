...
class PaymentAcquirer(models.Model):
    ...
    auto_confirm_invoice = fields.Selection([
        ('none', 'No automatic status change'),
        ('confirm', 'Auto-validate the invoice on acquirer confirmation')],
        string='Invoice Automatic Confirmation',
        default='confirm',
        required=True)
